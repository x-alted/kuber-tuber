...
| File | Description |
|------|-------------|
| [`SETUP-CHECKLIST.md`](./Setup-&-Testing-Checklist.md) | Hardware/OS validation checklist and weekly progress log. |
| [`NETWORK-TOPOLOGY.md`](./Network-Topology.md) | IP addresses, Tailscale details, network diagrams. |
| [`SERVICE-CONFIG.md`](./Service-Configuration.md) | Installation steps and configuration for K3s, Rancher, Dendrite, LoRa bridge. |
